...
class GPT(nn.Module):
    ...
    def forward(self, img_sequences, targets=None, use_perceptual_loss=False):
        ...
        tok_emb = self.input_mlp(img_sequences.view(-1, seqsize)).view(b,t,-1)
        ...
        mlp_logits = self.output_mlp(logits[:,-1,:]) # Take the last predicted token
